package edu.miu.cs590.hotelservice.service.impl;

import edu.miu.cs590.hotelservice.entity.HotelEntity;
import edu.miu.cs590.hotelservice.mapper.HotelMapper;
import edu.miu.cs590.hotelservice.mapper.RoomMapper;
import edu.miu.cs590.hotelservice.model.Hotel;
import edu.miu.cs590.hotelservice.model.Reservation;
import edu.miu.cs590.hotelservice.model.Room;
import edu.miu.cs590.hotelservice.repository.HotelRepository;
import edu.miu.cs590.hotelservice.repository.RoomRepository;
import edu.miu.cs590.hotelservice.service.HotelService;
import edu.miu.cs590.hotelservice.service.helper.ReservationFeignClient;
